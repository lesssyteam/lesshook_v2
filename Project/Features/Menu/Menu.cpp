...
// Menu Key
constexpr int MENU_KEY = SDL_SCANCODE_INSERT;
int unuPrimary = 0;
int unuSecondary = 0;

// Create the menu and start
// Getting other menus setup
void DrawMenu()
{
    // Before drawing menu
    ImGui::SetNextWindowSize(ImVec2(700, 700));

    // Draw Menu if were using it
    ImGui::Begin("Lesshook", nullptr, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize);
	{
        // TODO Add fonts 
        // TODO Add Footer
        // TODO Add Tabbar
        
        ImGui::Text("This menu works");
    }
...
// ############################################
//      MENU SDL_SWAP RENDERER USING SDL
// ###########################################
namespace SDL_RenderSwap
{
void Render(SDL_Window* window) 
{
	...
	if (!user_context) {user_context                = SDL_GL_CreateContext(window); ImGui_ImplSdl_Init(window);}
...
void __attribute__((constructor)) Attach() 
{
	...
	*swapwindow_ptr = reinterpret_cast<uintptr_t>(&Render);
}
